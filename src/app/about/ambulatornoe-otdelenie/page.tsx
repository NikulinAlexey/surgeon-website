      ...
      <main className="layout__main">
        ...
        <Section id="make-appointment" title="Как записаться на прием">
          <div className="cms">
            ...
            <p>Запись осуществляется только через Единый контакт-центр (ЕКЦ)</p>
            <p>
              Телефон: <Link href="tel:+74994900303">+7 (499) 490-03-03</Link>{" "}
              или <Link href="tel:+78006003141">+7 (800) 600-31-41</Link>
            </p>
            <div>
