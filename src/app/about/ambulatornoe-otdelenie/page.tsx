      ...
      <main className="layout__main">
        ...
        <Section id="make-appointment" title="Как записаться на прием">
          <div className="cms">
            ...
            <div>
              Запись осуществляется только через Единый контакт-центр (ЕКЦ) по
              телефону:
              <ul>
                <li>
                  <Link href="tel:+74994900303">+7 (499) 490-03-03</Link>,
                </li>
                <li>
                  <Link href="tel:+78006003141">+7 (800) 600-31-41</Link>.
                </li>
              </ul>
            </div>
            <div>
              В Едином контакт-центре (ЕКЦ) Вы сможете:
              <ul>
            ...
            <div>
              Важно!
              <div>
                Запись к врачам на консультацию по ОМС через сайт или в
