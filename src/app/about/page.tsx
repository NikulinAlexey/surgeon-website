            ...
            <div className="section__container container">
              ...
              <div className="about-page__content">
                <div className="about-page__text">
                  ...
                  <p>
                    Мы гордимся тем, что наша клиника соответствует самым
                    высоким стандартам медицинской помощи и использует только
                    проверенные и эффективные методы лечения.
                  </p>
                </div>
                <div className="about-page__image">
                  <img
                    src="/surgeon-website/images/clinic.jpg"
              ...
              <div className="about-page__team-grid">
                <div className="about-page__doctor-card">
                  <div className="about-page__doctor-photo">
                    <img
                      src="/surgeon-website/images/doctor1.jpg"
                      alt="Врач 1"
                    />
                  </div>
                  ...
                  <p className="about-page__doctor-experience">
                    Опыт работы: 15 лет
                  </p>
                </div>
                <div className="about-page__doctor-card">
                  <div className="about-page__doctor-photo">
                    <img
                      src="/surgeon-website/images/doctor2.jpg"
                      alt="Врач 2"
                    />
                  </div>
                ...
                <div className="about-page__doctor-card">
                  <div className="about-page__doctor-photo">
                    <img
                      src="/surgeon-website/images/doctor3.jpg"
                      alt="Врач 3"
                    />
                  </div>
            ...
            <div className="section__container container">
              ...
              <div className="about-page__advantages-grid">
                <div className="about-page__advantage">
                  ...
                  <p>
                    Используем новейшую диагностическую и лечебную аппаратуру
                  </p>
                </div>
                <div className="about-page__advantage">
