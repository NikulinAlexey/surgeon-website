...
const libraryItems = [
  {
    ...
    author: "Доктор Хаус",
    description: "Комплексное руководство по основам хирургических вмешательств.",
  ...
  },
  {
    ...
    description: "Полное руководство по лекарственным препаратам и их применению.",
  ...
  },
  {
    ...
    author: "Доктор Смит",
    description: "Современные подходы к лечению сердечно-сосудистых заболеваний.",
  ...
  },
  {
    ...
    description: "Практическое руководство по диагностике и лечению неврологических расстройств.",
          ...
          <div className="specialists-page">
                          ...
                          <div className="specialists-page__library-item">
                            <div className="specialists-page__library-icon">
                              <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M14 2H6C4.9 2 4.01 2.9 4.01 4L4 20C4 21.1 4.89 22 5.99 22H18C19.1 22 20 21.1 20 20V8L14 2ZM16 18H8V16H16V18ZM16 14H8V12H16V14ZM13 9V3.5L18.5 9H13Z" fill="#3498db"/>
                              </svg>
                            </div>
                            <div className="specialists-page__library-content">
                              <h3 className="specialists-page__library-title">{item.title}</h3>
                              <p className="specialists-page__library-author">Автор: {item.author}</p>
                              <p className="specialists-page__library-desc">{item.description}</p>
                            </div>
                            <a href={item.downloadLink} className="specialists-page__library-download" download>
                              Скачать PDF
                            </a>
                          </div>
                        </li>
            ...
            <section className="specialists-page__section">
              ...
              {!showQuestionForm ? (
                ...
                <form onSubmit={handleSubmitQuestion} className="specialists-page__question-form">
                  <textarea
                    value={questionText}
